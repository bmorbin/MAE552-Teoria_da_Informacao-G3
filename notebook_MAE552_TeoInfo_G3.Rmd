...
glioma <- gliomaGSE52009[1:50,]; as.data.frame(glioma)
...
<img src="linkages.png" alt="Linkages representação" style="max-height: 80vh; padding: 15px; max-width:100% !important;object-fit:contain"/>
</div>
